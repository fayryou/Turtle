...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener,
    ...
    public static void main(String[] a) {
        ...
        // make umbella
        new Thread(new Bob(0, 0, "lightpink")).start();

        // make some rain
        new Thread(new Bob2(-125, 0, "lightblue")).start();
        new Thread(new Bob3(-100, 0, "lightblue")).start();
        new Thread(new Bob4(-75, 0, "lightblue")).start();
        new Thread(new Bob5(-50, 0, "lightblue")).start();

        // write word rain in Thai
        new Thread(new Fon(-50, 0, "lightseagreen")).start();

        // add something
        new Thread(new Bob6(0, 0, "purple")).start();
